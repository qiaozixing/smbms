...
<div class="right">
       ...
       <form method="post" action="${pageContext.request.contextPath }/bill.html">
			<span>商品名称：</span>
			<input name="productName" type="text" value="${queryProductName }">
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${billList }" varStatus="status">
				<tr>
					...
					<td>
					<span><a class="viewBill" href="javascript:;" billid=${bill.bId } billcc=${bill.billCode }><img src="${pageContext.request.contextPath }/images/read.png" alt="查看" title="查看"/></a></span>
					<span><a class="modifyBill" href="javascript:;" billid=${bill.bId } billcc=${bill.billCode }><img src="${pageContext.request.contextPath }/images/xiugai.png" alt="修改" title="修改"/></a></span>
					<span><a class="deleteBill" href="javascript:;" billid=${bill.bId } billcc=${bill.billCode }><img src="${pageContext.request.contextPath }/images/schu.png" alt="删除" title="删除"/></a></span>
					</td>
				</tr>
			</c:forEach>
      </table>
